        ...
        while (opcion != 12) {
            ...
            switch (opcion) {
                ...
                case 4:
                    ...
                    Medico medicoConsulta=hospital.obtenerMedicoPorId(idMedico1);

                    System.out.println("Ingresa el id del consultorio ");
                    String idConsultorio1 = scanner.nextLine();
                    Consultorio consultorioConsulta = hospital.obtenerConsultorioPorId(idConsultorio1);
                     if(ValidadorHospital.validarDisponibilidadEnFechaConsulta==true && ValidadorHospital.validarDisponibilidadMedico==true  ){
                    ...
                    System.out.println("Se ha registrado tu consulta correctamente ");
                      } else { System.out.println("No se ha registrado tu consulta correctamente ");
                     }
                    break;
                case 5:
