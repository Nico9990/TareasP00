...
public class Menu {
    ...
    public int mostrarMenuPaciente(Paciente paciente){
        ...
        while (opcion!=4){
            ...
            System.out.println("2.-Mi informacion como paciente");
    ...
    public int mostrarMenuMedico(Medico medico){
        ...
        while (opcion != 7){
            ...
            System.out.println("6.-Mi info como medico");
   ...
   /* public int mostrarMenuAdmin(Administrador administrador){
    ...
    public int mostrarMenu(Administrador administrador) {
        ...
        while (opcion != 13) {
            ...
            System.out.println("12. Ver mis datos como Administrador");
            ...
            switch (opcion) {
                ...
                case 11:
                    ...
                    break;
                case 12:
                    System.out.println("Los datos del admin son:");
