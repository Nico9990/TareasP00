...
public class Hospital {
    ...
    public Hospital(){
        administrador = new Administrador("123","Nico","Guzman", fechaNacimientoAdmin,"443","GUD","12345",10, 7);
...
return listaPacientes.stream().filter(paciente -> paciente.getId().equals(id)).findFirst().orElse(null);
    ...
    public void mostrarConsultorios(){
        ...
        // non static se resolvio en consultorio poniendotodo minusculas en vez de Consultorio
    ...
    public void mostrarAdministradorPorId(String id){
        ...
        if (administrador != null) {
            ...
            System.out.println("El administrador con ese ID no existe pa! " + id);
        }
    }
    ...
    public Administrador obtenerAdministradorPorId(String idAdmin) {
        for (Administrador administrador : listaAdministradores) {
            if (administrador.getId().equals(idAdmin)) {
